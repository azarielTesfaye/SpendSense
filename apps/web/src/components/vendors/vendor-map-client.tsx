...
export function VendorMapClient({ initialData }: VendorMapClientProps) {
  ...
  // Update map markers when vendors data updates
  useEffect(() => {
    ...
    import("leaflet").then((L) => {
      ...
      initialData.results.forEach((vendor) => {
        ...
        // Customize marker based on verification status and price levels
        ...
        // Select vendor card on marker click
        marker.on("click", () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] w-full overflow-hidden bg-background">
      ...
      <div className="flex flex-1 w-full overflow-hidden relative">
        ...
        >
          {/* Detailed Selected Vendor Overlay Sheet */}
          {selectedVendor ? (
